...
import com.learn.springbootsecurity.constant.SecurityConstant;
...
public class JwtTokenGenerationFilter extends OncePerRequestFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		{
		   SecretKey secretKey = Keys.hmacShaKeyFor(SecurityConstant.JWT_KEY.getBytes(StandardCharset.UTF_8));
		   ...
		   String jwt = Jwts.builder().setIssuer("Spring Security").setSubject("JWT Token")
				         ...
				         .setExpiration(new Date((new Date()).getTime() + 60000)) //Token Valid for 60 second only
	...
	//This method is responsible to execute this filter only if our requested url is /generate-token 
	@Override
	protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException 
	{
           return !request.getServletPath().equals("/generate-token");
	}
